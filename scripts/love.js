(function(window){
    ...
    Tree.prototype.initBranch = function() {
        ...
        if (branchs.length === 0) {
            console.warn("⚠ No branches found! Adding a default one.");
            branchs = [
                [500, 650, 500, 400, 500, 300, 10, 80, []] // Example branch
            ];
        }
        ...
        console.log(`🌿 Initialized ${this.branchs.length} branches.`);
    };
    ...
    Tree.prototype.grow = function() {
        ...
        if (branchs.length === 0) {
            console.error("❌ No branches to grow!");
            return;
        }
    
        console.log(`🌱 Growing ${branchs.length} branches...`);
        ...
        this.ctx.clearRect(0, 0, this.width, this.height); // Force canvas to refresh
        this.seed.draw(); // Ensure the seed remains visible
    };
